...
- Keep changes and regression tests minimal and proportional. Public docs describe
  current behavior only; keep investigation history and machine-specific context in
  ignored `./notes`.
